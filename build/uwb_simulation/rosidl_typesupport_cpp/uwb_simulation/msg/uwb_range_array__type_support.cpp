...
static const _UwbRangeArray_type_support_symbol_names_t _UwbRangeArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uwb_simulation, msg, UwbRangeArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uwb_simulation, msg, UwbRangeArray)),
  }
};
...
{
  return &::uwb_simulation::msg::rosidl_typesupport_cpp::UwbRangeArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uwb_simulation, msg, UwbRangeArray)() {
  return get_message_type_support_handle<uwb_simulation::msg::UwbRangeArray>();
}
