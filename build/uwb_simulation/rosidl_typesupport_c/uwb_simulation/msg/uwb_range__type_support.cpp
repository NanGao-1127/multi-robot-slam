...
static const _UwbRange_type_support_symbol_names_t _UwbRange_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uwb_simulation, msg, UwbRange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uwb_simulation, msg, UwbRange)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, uwb_simulation, msg, UwbRange)() {
  return &::uwb_simulation::msg::rosidl_typesupport_c::UwbRange_message_type_support_handle;
}
