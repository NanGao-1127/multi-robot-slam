...
#include "uwb_simulation/msg/detail/uwb_range__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uwb_simulation::msg::UwbRange & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uwb_simulation::msg::UwbRange & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uwb_simulation::msg::UwbRange;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const uwb_simulation::msg::UwbRange *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uwb_simulation::msg::UwbRange *>(
    untyped_ros_message);
...
get_message_type_support_handle<uwb_simulation::msg::UwbRange>()
{
  return &uwb_simulation::msg::typesupport_fastrtps_cpp::_UwbRange__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uwb_simulation, msg, UwbRange)() {
  return &uwb_simulation::msg::typesupport_fastrtps_cpp::_UwbRange__handle;
}
