...
bool multi_robot_slam__msg__map_merge_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("multi_robot_slam.msg._map_merge_status.MapMergeStatus", full_classname_dest, 53) == 0);
  }
  multi_robot_slam__msg__MapMergeStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // maps_aligned
    PyObject * field = PyObject_GetAttrString(_pymsg, "maps_aligned");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->maps_aligned = (Py_True == field);
    Py_DECREF(field);
  }
  {  // merge_successful
    PyObject * field = PyObject_GetAttrString(_pymsg, "merge_successful");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->merge_successful = (Py_True == field);
    Py_DECREF(field);
  }
  {  // num_robots
    PyObject * field = PyObject_GetAttrString(_pymsg, "num_robots");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->num_robots = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // robot_ids
  ...
  {  // alignment_score
    PyObject * field = PyObject_GetAttrString(_pymsg, "alignment_score");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->alignment_score = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // overlap_ratio
...
{
  /* NOTE(esteve): Call constructor of MapMergeStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("multi_robot_slam.msg._map_merge_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MapMergeStatus");
  ...
  {  // maps_aligned
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->maps_aligned ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "maps_aligned", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // merge_successful
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->merge_successful ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "merge_successful", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // num_robots
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->num_robots);
    {
      int rc = PyObject_SetAttrString(_pymessage, "num_robots", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // alignment_score
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->alignment_score);
    {
      int rc = PyObject_SetAttrString(_pymessage, "alignment_score", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
