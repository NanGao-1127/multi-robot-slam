...
#include "multi_robot_slam/msg/detail/pose_graph__rosidl_typesupport_fastrtps_c.h"
...
#include "multi_robot_slam/msg/detail/pose_graph_edge__functions.h"  // edges
#include "multi_robot_slam/msg/detail/pose_graph_node__functions.h"  // nodes
...
size_t get_serialized_size_multi_robot_slam__msg__PoseGraphNode(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_multi_robot_slam__msg__PoseGraphNode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_robot_slam, msg, PoseGraphNode)();
...
using _PoseGraph__ros_msg_type = multi_robot_slam__msg__PoseGraph;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: nodes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, multi_robot_slam, msg, PoseGraphNode
      )()->data);
  ...
  // Field name: edges
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, multi_robot_slam, msg, PoseGraphEdge
      )()->data);
  ...
  // Field name: is_optimized
  {
    cdr << (ros_message->is_optimized ? true : false);
  }

  // Field name: optimization_cost
  {
    cdr << ros_message->optimization_cost;
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: nodes
  {
    ...
    if (ros_message->nodes.data) {
      multi_robot_slam__msg__PoseGraphNode__Sequence__fini(&ros_message->nodes);
    }
  ...
  // Field name: edges
  {
    ...
    if (ros_message->edges.data) {
      multi_robot_slam__msg__PoseGraphEdge__Sequence__fini(&ros_message->edges);
    }
  ...
  // Field name: is_optimized
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->is_optimized = tmp ? true : false;
  }
...
size_t get_serialized_size_multi_robot_slam__msg__PoseGraph(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PoseGraph__ros_msg_type * ros_message = static_cast<const _PoseGraph__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_multi_robot_slam__msg__PoseGraphNode(
  ...
  // field.name edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_multi_robot_slam__msg__PoseGraphEdge(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name is_optimized
  {
    size_t item_size = sizeof(ros_message->is_optimized);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name optimization_cost
  {
    size_t item_size = sizeof(ros_message->optimization_cost);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name num_iterations
...
static uint32_t _PoseGraph__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_multi_robot_slam__msg__PoseGraph(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_multi_robot_slam
size_t max_serialized_size_multi_robot_slam__msg__PoseGraph(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_multi_robot_slam__msg__PoseGraphNode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_multi_robot_slam__msg__PoseGraphEdge(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = multi_robot_slam__msg__PoseGraph;
    is_plain =
      (
      offsetof(DataType, num_iterations) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PoseGraph__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_multi_robot_slam__msg__PoseGraph(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_robot_slam, msg, PoseGraph)() {
