...
#include "multi_robot_slam/msg/detail/map_merge_status__rosidl_typesupport_fastrtps_c.h"
...
using _MapMergeStatus__ros_msg_type = multi_robot_slam__msg__MapMergeStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MapMergeStatus__ros_msg_type * ros_message = static_cast<const _MapMergeStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MapMergeStatus__ros_msg_type * ros_message = static_cast<_MapMergeStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_multi_robot_slam__msg__MapMergeStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MapMergeStatus__ros_msg_type * ros_message = static_cast<const _MapMergeStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MapMergeStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_multi_robot_slam__msg__MapMergeStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_multi_robot_slam
size_t max_serialized_size_multi_robot_slam__msg__MapMergeStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_robot_slam__msg__MapMergeStatus;
    is_plain =
      (
...
static size_t _MapMergeStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_multi_robot_slam__msg__MapMergeStatus(
...
static message_type_support_callbacks_t __callbacks_MapMergeStatus = {
...
static rosidl_message_type_support_t _MapMergeStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MapMergeStatus,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_robot_slam, msg, MapMergeStatus)() {
  return &_MapMergeStatus__type_support;
}
