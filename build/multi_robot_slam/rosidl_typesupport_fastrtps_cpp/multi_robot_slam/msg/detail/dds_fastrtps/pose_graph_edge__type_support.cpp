...
#include "multi_robot_slam/msg/detail/pose_graph_edge__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const multi_robot_slam::msg::PoseGraphEdge & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.information_matrix;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_robot_slam::msg::PoseGraphEdge & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: information_matrix
  {
    ...
    size_t item_size = sizeof(ros_message.information_matrix[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_robot_slam::msg::PoseGraphEdge;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_robot_slam::msg::PoseGraphEdge *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<multi_robot_slam::msg::PoseGraphEdge *>(
    untyped_ros_message);
...
{
  return &multi_robot_slam::msg::typesupport_fastrtps_cpp::_PoseGraphEdge__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_robot_slam, msg, PoseGraphEdge)() {
  return &multi_robot_slam::msg::typesupport_fastrtps_cpp::_PoseGraphEdge__handle;
}
