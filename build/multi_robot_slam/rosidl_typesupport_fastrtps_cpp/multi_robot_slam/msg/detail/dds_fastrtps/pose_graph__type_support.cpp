...
#include "multi_robot_slam/msg/detail/pose_graph__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const multi_robot_slam::msg::PoseGraphNode &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  multi_robot_slam::msg::PoseGraphNode &);
size_t get_serialized_size(
  const multi_robot_slam::msg::PoseGraphNode &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const multi_robot_slam::msg::PoseGraphEdge &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const multi_robot_slam::msg::PoseGraph & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t i = 0; i < size; i++) {
      multi_robot_slam::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.nodes[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_robot_slam::msg::PoseGraph & ros_message)
{
  // Member: header
  ...
  // Member: nodes
  {
    ...
    for (size_t i = 0; i < size; i++) {
      multi_robot_slam::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        multi_robot_slam::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        multi_robot_slam::msg::typesupport_fastrtps_cpp::max_serialized_size_PoseGraphNode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        multi_robot_slam::msg::typesupport_fastrtps_cpp::max_serialized_size_PoseGraphEdge(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = multi_robot_slam::msg::PoseGraph;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_robot_slam::msg::PoseGraph *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<multi_robot_slam::msg::PoseGraph *>(
    untyped_ros_message);
...
{
  return &multi_robot_slam::msg::typesupport_fastrtps_cpp::_PoseGraph__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_robot_slam, msg, PoseGraph)() {
  return &multi_robot_slam::msg::typesupport_fastrtps_cpp::_PoseGraph__handle;
}
