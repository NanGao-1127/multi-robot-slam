...
static const _PoseGraphEdge_type_support_symbol_names_t _PoseGraphEdge_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_robot_slam, msg, PoseGraphEdge)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_robot_slam, msg, PoseGraphEdge)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, multi_robot_slam, msg, PoseGraphEdge)() {
  return &::multi_robot_slam::msg::rosidl_typesupport_c::PoseGraphEdge_message_type_support_handle;
}
