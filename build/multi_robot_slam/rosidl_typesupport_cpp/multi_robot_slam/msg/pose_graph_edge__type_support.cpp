...
static const _PoseGraphEdge_type_support_symbol_names_t _PoseGraphEdge_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_robot_slam, msg, PoseGraphEdge)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, multi_robot_slam, msg, PoseGraphEdge)),
  }
};
...
{
  return &::multi_robot_slam::msg::rosidl_typesupport_cpp::PoseGraphEdge_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, multi_robot_slam, msg, PoseGraphEdge)() {
  return get_message_type_support_handle<multi_robot_slam::msg::PoseGraphEdge>();
}
