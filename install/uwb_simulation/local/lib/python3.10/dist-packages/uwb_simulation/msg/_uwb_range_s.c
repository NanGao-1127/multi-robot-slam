...
bool uwb_simulation__msg__uwb_range__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uwb_simulation.msg._uwb_range.UwbRange", full_classname_dest, 38) == 0);
  }
  uwb_simulation__msg__UwbRange * ros_message = _ros_message;
  {  // header
  ...
  {  // range_std
    PyObject * field = PyObject_GetAttrString(_pymsg, "range_std");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->range_std = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // measurement_time
    ...
    if (!builtin_interfaces__msg__time__convert_from_py(field, &ros_message->measurement_time)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * uwb_simulation__msg__uwb_range__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uwb_simulation.msg._uwb_range");
  ...
  {  // range_std
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->range_std);
    {
      int rc = PyObject_SetAttrString(_pymessage, "range_std", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // measurement_time
    PyObject * field = NULL;
    field = builtin_interfaces__msg__time__convert_to_py(&ros_message->measurement_time);
    if (!field) {
      return NULL;
    }
    {
