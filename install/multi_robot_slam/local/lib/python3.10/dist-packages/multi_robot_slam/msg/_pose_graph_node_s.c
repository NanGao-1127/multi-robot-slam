...
bool multi_robot_slam__msg__pose_graph_node__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("multi_robot_slam.msg._pose_graph_node.PoseGraphNode", full_classname_dest, 51) == 0);
  }
  multi_robot_slam__msg__PoseGraphNode * ros_message = _ros_message;
  {  // header
...
PyObject * multi_robot_slam__msg__pose_graph_node__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("multi_robot_slam.msg._pose_graph_node");
